...
from .views import LogoutView, getChartParameters, getChartParametersTwo, getTable
...
urlpatterns = [
    ...
    path('api/v1/doctors/', include('patients.urls')),
    path('api/v1/patients/', include('doctors.urls')),
